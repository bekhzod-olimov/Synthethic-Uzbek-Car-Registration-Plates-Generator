...
def copy_files(im_paths, destination): 
    ...
    Parameters:
        ...
        im_paths    - paths to the images from domain A and B, str;
    ...
    for file in im_paths: shutil.copy(file, destination)
...
for arg in vars(args): print('[%s] = ' % arg, getattr(args, arg))
...
os.makedirs(args.trainA, exist_ok = True); os.makedirs(args.trainB, exist_ok = True)
print("Copying images...")

# Copy the images
copy_files(input_im_paths, args.trainA); copy_files(output_im_paths, args.trainB)
print("Done!")
